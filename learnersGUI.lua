...
getgenv().le = getgenv().le or loadstring(game:HttpGet(
    "https://raw.githubusercontent.com/ilearners/learners/refs/heads/main/learnersInterface.lua"
))()
...
getgenv().uilibray = getgenv().uilibray or loadstring(game:HttpGet(
    "https://raw.githubusercontent.com/ilearners/learners/refs/heads/main/RE%3ARayfield"
))()
